...
document.addEventListener('click',e=>{const btn=e.target.closest('.delbtn');if(btn)del(btn.dataset.kind,btn.dataset.id)})
load()
</script></body></html>"""
